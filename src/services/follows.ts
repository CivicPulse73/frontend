...
export const followService = {
  ...
  async getFollowStats(userId: string): Promise<FollowStats> {
    ...
    return {
      ...
      mutual_follows_count: response.data.mutual_follows_count
    }
  }

  // DEPRECATED: getFollowStatus method removed
  // Follow status should now be obtained from main API responses (posts, user profiles)
  // with include_follow_status=true parameter instead of separate API calls
}
