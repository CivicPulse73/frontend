            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              <div className="space-y-2">
                <div className="bg-gray-50 p-2 rounded">
                  ...
                  <br />
                  <span className="text-gray-800 font-mono">{locationData.latitude.toFixed(6)}, {locationData.longitude.toFixed(6)}</span>
                </div>
                {locationData.city && (
                  <div className="bg-gray-50 p-2 rounded">
                    <span className="font-medium text-gray-600">🏘️ City:</span>
                    <br />
                    <span className="text-gray-800">{locationData.city}</span>
                  </div>
                )}
              </div>
              <div className="space-y-2">
                {locationData.state && (
                  <div className="bg-gray-50 p-2 rounded">
                    <span className="font-medium text-gray-600">🏛️ State:</span>
                    <br />
                    <span className="text-gray-800">{locationData.state}</span>
                  </div>
                )}
                {locationData.pincode && (
                  <div className="bg-gray-50 p-2 rounded">
                    ...
                    <br />
                    <span className="text-gray-800">{locationData.pincode}</span>
                  </div>
                )}
              </div>
            </div>
