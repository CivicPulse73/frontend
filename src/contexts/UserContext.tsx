...
export const UserProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const register = async (userData: RegisterData): Promise<User> => {
    try {
      ...
      console.log('📝 UserContext: Input userData:', userData)
      ...
      const registerData: RegisterRequest = {
        ...
        // Base location fields
        base_latitude: userData.base_latitude,
        base_longitude: userData.base_longitude
      }
      
      console.log('📝 UserContext: Sending registerData:', registerData)
